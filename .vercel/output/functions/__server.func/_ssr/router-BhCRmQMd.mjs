...
const appCss = "/assets/styles-BtKNClD0.css";
...
const Route$2 = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { title: "Sikhya — Premium Punjab Government Exam Books & Study Material" },
      { name: "description", content: "Crack Punjab Police, Patwari, PPSC, PSPCL and Clerk exams with expert-curated books, previous year papers and mock tests trusted by thousands of aspirants." },
      { name: "author", content: "Sikhya" },
      { property: "og:title", content: "Sikhya — Premium Punjab Government Exam Books" },
      { property: "og:description", content: "Premium books, updated syllabus, PYQs and complete preparation resources for every major Punjab Government exam." },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Sikhya" },
